...
public class ArquivoRemessaAtualizar {
    ...
    public ArquivoRemessaAtualizar(List<Contasreceber> listaCotnas, UsuarioLogadoMB usuarioLogadoMB) {
        ...
        if (this.listaCotnas!=null){
            ...
            try {
                ...
                try {
                    ...
                    Logger.getLogger(ArquivoRemessaAtualizar.class.getName()).log(Level.SEVERE, null, ex);
                }
